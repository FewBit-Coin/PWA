			...
			<div class="py-1 px-10 flex items-center">
				<div class="flex me-auto">
					...
					<NuxtLink
						...
						:to="localePath('/')"
					>
						<img :src="logo" :alt="$t('appName')" class="my-2 min-h-[36px] min-w-[55px] h-10 w-10 py-1" />
						<span class="text-2xl">FewBit Coin</span>
					</NuxtLink>
				</div>
              ...
              <Language class="dark:hover:text-light_blue-50 hover:text-dark_blue-900" />
					...
					<div
						:class="{ 'left-[0vw]': showingNavigationDropdown, 'left-[100vw]': !showingNavigationDropdown }"
					...
					>
						...
						>
							<div
								class="h-[70px] top-0 w-[222px] bg-[rgba(237,241,236,0.99)] dark:bg-[rgba(4,12,3,0.99)] fixed z-40"
							></div>
							<ul
								class="rtl:dir-rtl lrt:dir-ltr text-sm font-bold gap-1 p-2 justify-center items-start flex flex-col"
							>
								<li class="w-full">
									<NuxtLink
