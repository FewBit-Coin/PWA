...
<template>
	<div>
		<button
			...
			id="openSideBar"
			class="h-10 w-10 md:hidden z-40 bg-black-900 text-blue-100 fixed top-0 ltr:left-0 rtl:right-0 mt-3 flex items-center shadow ltr:rounded-r-full rtl:rounded-l-full justify-center cursor-pointer focus:outline-none transition duration-150 ease-in-out"
		...
		<div class="fixed md:relative z-30 min-h-screen md:flex">
			...
			<div
				class="min-h-screen z-30 w-64 absolute md:relative bg-dark_blue-700 shadow ms:h-full flex-col justify-between hidden md:flex"
			>
				<div style="min-height: calc(100vh - 59px)" class="px-5">
					<div class="h-20 pt-4 flex items-center ms-6">
						<!-- logo -->
						<NuxtLink
							data-track-arguments="brand, event, Navbar, Home"
							:title="$t('appName')"
						...
						<div class="flex flex-col">
							<NuxtLink
								to="#"
								class="text-blue-100 hover:text-blue-50 text-sm font-extrabold truncate w-32"
							>
					...
					<ul class="mt-12">
						<li
							class="flex w-full justify-between text-blue-100 hover:text-blue-50 cursor-pointer items-center mb-6"
						>
              ...
              <Language :dashStyle="true" />
						...
						<li class="cursor-pointer px-1 py-2 text-blue-100">
							...
							<button
								@click="handleLogout"
								aria-label="logout"
								class="focus:outline-none rounded focus:text-lime-100"
							>
			...
			<div
				class="overflow-y-scroll scrollbar-thumb-blue-800 scrollbar-thin scrollbar-track-blue-500 scroll-smooth max-h-screen absolute min-h-screen w-64 z-30 bg-dark_blue-700 shadow md:h-full flex-col justify-between md:hidden transition duration-150 ease-in-out"
				id="mobile-nav"
				:class="sideBarStyle"
			>
				<div style="min-height: calc(100vh - 59px)" class="px-5">
